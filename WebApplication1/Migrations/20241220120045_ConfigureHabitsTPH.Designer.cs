...
namespace WebApplication1.Migrations
{
    ...
    [Migration("20241220120045_ConfigureHabitsTPH")]
    partial class ConfigureHabitsTPH
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebApplication1.model.BadHabits", b =>
                {
                    ...
                    b.HasDiscriminator().HasValue("BadHabit");
                });
            ...
            modelBuilder.Entity("WebApplication1.model.GoodHabits", b =>
                {
                    ...
                    b.HasDiscriminator().HasValue("GoodHabit");
                });
            ...
            modelBuilder.Entity("WebApplication1.model.RecordOfExecution", b =>
                {
                    b.HasOne("WebApplication1.model.Habits", "Habits")
                        .WithMany()
